...
const SYNC_SOURCES = [
  ...
  { key: 'rentzone', label: '렌트존', desc: '렌트존 (PT-0014)' },
  ...
  { key: 'ecorent', label: '에코렌트카', desc: '에코렌트카 (RP032)' },
];
...
function renderCleanupTab(el) {
  ...
  const CLEANUP_SOURCES = ['autoplus','songogong','aicar','pacific','leaders','star','rentzone',
    'gyeongjinRent','gyeongjinCar','wooriCapital','kh','centro','billin','ian','wellix','sarent','jnj','iancar','ecorent'];
